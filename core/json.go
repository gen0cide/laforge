		...
		case "resources":
			if in.IsNull() {
				...
				if out.Resources == nil {
					if !in.IsDelim(']') {
						out.Resources = make([]MetaResource, 0, 0)
					} else {
...
func easyjsonA5722a85DecodeGithubComGen0cideLaforgeCore32(in *jlexer.Lexer, out *Environment) {
	...
	for !in.IsDelim('}') {
		...
		case "vdi_allowed_tcp_ports":
			if in.IsNull() {
				in.Skip()
				out.ExposedVDIPorts = nil
			} else {
				in.Delim('[')
				if out.ExposedVDIPorts == nil {
					if !in.IsDelim(']') {
						out.ExposedVDIPorts = make([]string, 0, 4)
					} else {
						out.ExposedVDIPorts = []string{}
					}
				} else {
					out.ExposedVDIPorts = (out.ExposedVDIPorts)[:0]
				}
				for !in.IsDelim(']') {
					var v144 string
					v144 = string(in.String())
					out.ExposedVDIPorts = append(out.ExposedVDIPorts, v144)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "included_networks":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v147 *IncludedNetwork
					if in.IsNull() {
						in.Skip()
						v147 = nil
					} else {
						if v147 == nil {
							v147 = new(IncludedNetwork)
						}
						(*v147).UnmarshalEasyJSON(in)
					}
					out.Networks = append(out.Networks, v147)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonA5722a85EncodeGithubComGen0cideLaforgeCore32(out *jwriter.Writer, in Environment) {
	...
	if len(in.AdminCIDRs) != 0 {
		...
		{
			out.RawByte('[')
			for v148, v149 := range in.AdminCIDRs {
				if v148 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.ExposedVDIPorts) != 0 {
		const prefix string = ",\"vdi_allowed_tcp_ports\":"
		if first {
			first = false
			out.RawString(prefix[1:])
		} else {
		...
		{
			out.RawByte('[')
			for v150, v151 := range in.ExposedVDIPorts {
				if v150 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.Tags) != 0 {
		...
		}
		{
			out.RawByte('{')
			v153First := true
			for v153Name, v153Value := range in.Tags {
				if v153First {
					v153First = false
				} else {
					out.RawByte(',')
	...
	if len(in.Networks) != 0 {
		...
		{
			out.RawByte('[')
			for v154, v155 := range in.Networks {
				if v154 > 0 {
					out.RawByte(',')
				}
				if v155 == nil {
		...
		case "values":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Values = append(out.Values, v156)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonA5722a85EncodeGithubComGen0cideLaforgeCore36(out *jwriter.Writer, in DNSRecord) {
	...
	if len(in.Vars) != 0 {
		...
		}
		{
			out.RawByte('{')
			v161First := true
			for v161Name, v161Value := range in.Vars {
				if v161First {
					v161First = false
				} else {
					out.RawByte(',')
	...
	if len(in.Tags) != 0 {
		...
		}
		{
			out.RawByte('{')
			v162First := true
			for v162Name, v162Value := range in.Tags {
				if v162First {
					v162First = false
				} else {
					out.RawByte(',')
		...
		case "dns_servers":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.DNSServers = append(out.DNSServers, v163)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "ntp_servers":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.NTPServers = append(out.NTPServers, v164)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonA5722a85EncodeGithubComGen0cideLaforgeCore37(out *jwriter.Writer, in DNS) {
	...
	if len(in.DNSServers) != 0 {
		...
		{
			out.RawByte('[')
			for v166, v167 := range in.DNSServers {
				if v166 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.NTPServers) != 0 {
		...
		{
			out.RawByte('[')
			for v168, v169 := range in.NTPServers {
				if v168 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.Config) != 0 {
		...
		}
		{
			out.RawByte('{')
			v170First := true
			for v170Name, v170Value := range in.Config {
				if v170First {
					v170First = false
				} else {
					out.RawByte(',')
...
func easyjsonA5722a85EncodeGithubComGen0cideLaforgeCore39(out *jwriter.Writer, in Competition) {
	...
	if len(in.Config) != 0 {
		...
		}
		{
			out.RawByte('{')
			v172First := true
			for v172Name, v172Value := range in.Config {
				if v172First {
					v172First = false
				} else {
					out.RawByte(',')
