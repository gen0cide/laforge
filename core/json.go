...
func easyjsonA5722a85EncodeGithubComGen0cideLaforgeCore9(out *jwriter.Writer, in Revision) {
	...
	}
	{
		...
		if in.Vars == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v30First := true
			for v30Name, v30Value := range in.Vars {
				if v30First {
					v30First = false
				} else {
					out.RawByte(',')
...
func easyjsonA5722a85EncodeGithubComGen0cideLaforgeCore11(out *jwriter.Writer, in RemoteFile) {
	...
	if len(in.Vars) != 0 {
		...
		}
		{
			out.RawByte('{')
			v33First := true
			for v33Name, v33Value := range in.Vars {
				if v33First {
					v33First = false
				} else {
					out.RawByte(',')
	...
	if len(in.Tags) != 0 {
		...
		}
		{
			out.RawByte('{')
			v34First := true
			for v34Name, v34Value := range in.Tags {
				if v34First {
					v34First = false
				} else {
					out.RawByte(',')
...
func easyjsonA5722a85EncodeGithubComGen0cideLaforgeCore12(out *jwriter.Writer, in Remote) {
	...
	if len(in.Config) != 0 {
		...
		}
		{
			out.RawByte('{')
			v36First := true
			for v36Name, v36Value := range in.Config {
				if v36First {
					v36First = false
				} else {
					out.RawByte(',')
		...
		case "provisioned_hosts":
			if in.IsNull() {
				...
				for !in.IsDelim('}') {
					key := string(in.String())
					in.WantColon()
					var v37 *ProvisionedHost
					if in.IsNull() {
						in.Skip()
						v37 = nil
					} else {
						if v37 == nil {
							v37 = new(ProvisionedHost)
						}
						(*v37).UnmarshalEasyJSON(in)
					}
					(out.ProvisionedHosts)[key] = v37
					in.WantComma()
				}
				in.Delim('}')
			}
...
func easyjsonA5722a85EncodeGithubComGen0cideLaforgeCore14(out *jwriter.Writer, in ProvisionedNetwork) {
	...
	}
	{
		...
		if in.ProvisionedHosts == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v38First := true
			for v38Name, v38Value := range in.ProvisionedHosts {
				if v38First {
					v38First = false
				} else {
					out.RawByte(',')
		...
		case "provisioning_steps":
			if in.IsNull() {
				...
				for !in.IsDelim('}') {
					key := string(in.String())
					in.WantColon()
					var v39 *ProvisioningStep
					if in.IsNull() {
						in.Skip()
						v39 = nil
					} else {
						if v39 == nil {
							v39 = new(ProvisioningStep)
						}
						(*v39).UnmarshalEasyJSON(in)
					}
					(out.ProvisioningSteps)[key] = v39
					in.WantComma()
				}
				in.Delim('}')
			}
...
func easyjsonA5722a85EncodeGithubComGen0cideLaforgeCore15(out *jwriter.Writer, in ProvisionedHost) {
	...
	}
	{
		...
		if in.ProvisioningSteps == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v40First := true
			for v40Name, v40Value := range in.ProvisioningSteps {
				if v40First {
					v40First = false
				} else {
					out.RawByte(',')
		...
		case "global_order":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.GlobalOrder = append(out.GlobalOrder, v44)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "ordered_priorities":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v45 int
					v45 = int(in.Int())
					out.OrderedPriorities = append(out.OrderedPriorities, v45)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonA5722a85EncodeGithubComGen0cideLaforgeCore16(out *jwriter.Writer, in Plan) {
	...
	}
	{
		...
		if in.TaskTypes == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v47First := true
			for v47Name, v47Value := range in.TaskTypes {
				if v47First {
					v47First = false
				} else {
					out.RawByte(',')
	...
	}
	{
		...
		if in.TasksByPriority == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v48First := true
			for v48Name, v48Value := range in.TasksByPriority {
				if v48First {
					v48First = false
				} else {
					out.RawByte(',')
	...
	}
	{
		...
		if in.GlobalOrder == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v51, v52 := range in.GlobalOrder {
				if v51 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.OrderedPriorities == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v53, v54 := range in.OrderedPriorities {
				if v53 > 0 {
					out.RawByte(',')
				}
				out.Int(int(v54))
	...
	}
	{
		...
		if in.Tainted == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v55First := true
			for v55Name, v55Value := range in.Tainted {
				if v55First {
					v55First = false
				} else {
					out.RawByte(',')
