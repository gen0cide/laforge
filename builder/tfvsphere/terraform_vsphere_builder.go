...
const (
	...
	Description = `generates terraform configurations that isolate teams into private networks on an esxi server.`
	Author      = `JC Alvarado, Russ Babarsky, Brandon Dossantos, Chris Rispoli`
	Version     = `0.0.1`
)
