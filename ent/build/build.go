...
const (
	...
	// BuildToLatestBuildCommitTable is the table the holds the BuildToLatestBuildCommit relation/edge.
	...
	// BuildToBuildCommitsTable is the table the holds the BuildToBuildCommits relation/edge.
